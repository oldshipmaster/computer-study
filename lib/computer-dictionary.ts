...
export const DICTIONARY_ENTRIES: readonly DictionaryEntry[] = [
  ...
  { id: "cpu", islandId: "hardware-lab", courseId: "cpu-memory-storage", term: "处理器", english: "CPU", explanation: "读取并执行指令、处理数据的电脑部件。", example: "它会计算游戏角色下一步应该出现在哪里。" },
  { id: "memory-storage", islandId: "hardware-lab", courseId: "cpu-memory-storage", term: "内存与存储", english: "Memory and storage", explanation: "内存放正在使用的内容，存储长期保存文件。", example: "关机后内存里的临时工作会消失，保存的文件还在。" },
  { id: "network", islandId: "network-bay", courseId: "network-journey", term: "网络", english: "Network", explanation: "让多台设备能够互相传递信息的连接。", example: "家里的电脑可以通过网络向网站服务器请求页面。" },
