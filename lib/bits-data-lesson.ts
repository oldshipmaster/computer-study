...
export function byteToDemoCharacter(bits: readonly Bit[]): string | null { if (bits.length !== 8) return null; const value = bitsToNumber(bits); return value >= 65 && value <= 90 ? String.fromCharCode(value) : null; }
