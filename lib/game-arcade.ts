...
export const GAME_ARCADE_DEFINITIONS: GameArcadeDefinition[] = [
  ...
  { id: "robot", targetId: "robot-code-expedition", title: "机器人代码远征", icon: "🤖", mechanic: "编排指令并逐步调试地图", duration: "8–10 分钟", category: "code", gate: { type: "exact", courseIds: ["instruction-order", "grid-city-navigation", "repeat-power", "rainy-condition", "bug-catcher"] } },
  ...
  { id: "championship", targetId: "island-championship-relay", title: "十三岛冠军联赛", icon: "🏆", mechanic: "十三回合跨岛证据决策终局赛", duration: "8–10 分钟", category: "quest", gate: { type: "exact", courseIds: COURSES.map((course) => course.id) } },
];
