...
test("server-renders the complete curriculum map", async () => {
  ...
  assert.match(html, /正在下潜系统深海总控台/);
  assert.match(html, /正在集合十三岛冠军联赛/);
