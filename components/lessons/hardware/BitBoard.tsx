...
import { bitsToColor, bitsToNumber, byteToDemoCharacter, type Bit } from "@/lib/bits-data-lesson";
...
export function BitBoard({ onComplete }: Props) {
  ...
  const byteCharacter = width === 8 ? byteToDemoCharacter(bits) : null;
