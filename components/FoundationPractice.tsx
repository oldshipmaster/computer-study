...
export function FoundationPractice({ onStartCourse }: { onStartCourse: (courseId: string) => void }) {
  ...
  function next() { movingRef.current = true; setIndex((value) => value + 1); setChoice(null); }
  function restart() { movingRef.current = true; setRound((value) => value + 1); setIndex(0); setChoice(null); setScore(0); }
