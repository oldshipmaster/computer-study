        ...
        <div className="parent-panel-grid">
          <section className="parent-progress-card" aria-labelledby="local-progress-title">
            ...
            <div className="parent-review-guide">
              <h3>孩子标记的复习课</h3>
              <div className="parent-confidence-stats" aria-label={`已自评 ${confidenceStats.rated} 课`} role="group"><span><strong>{confidenceStats.confident}</strong>会讲</span><span><strong>{confidenceStats.practice}</strong>再练</span><span><strong>{confidenceStats.help}</strong>需帮助</span><span><strong>{confidenceStats.unrated}</strong>未自评</span></div>
