  ...
  return (
    <section className="learning-plan" aria-labelledby="learning-plan-heading">
      <div className="learning-plan-heading">
        <div><p className="section-kicker">五次探险计划</p><h2 id="learning-plan-heading">一次一小步，八座岛轮换练</h2></div>
        {!plan.complete ? <strong>约 {plan.totalMinutes} 分钟 · 分 5 次完成</strong> : null}
      </div>
      {plan.complete ? <div className="learning-plan-complete"><span aria-hidden="true">🎉</span><p>四十课都完成了！任选一课重玩，试着把原理讲给别人听。</p></div> : <ol>
